  ...
  return (
    <div className="privacy-policy">
      ...
      <ul>
        ...
        <li>
          <p><strong>Website</strong> refers to Package Tracker, accessible from <a href="https://package-tracker-bl.herokuapp.com/" rel="noreferrer" target="_blank">https://package-tracker-bl.herokuapp.com/</a></p>
        </li>
        <li>
